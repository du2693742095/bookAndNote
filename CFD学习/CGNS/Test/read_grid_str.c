...
/* open CGNS file for read-only */
    if (cg_open("D:\\Test\\CGNS\\CGNS-4.3.0\\out\\build\\x64-Debug\\src\\Test_UserGuideCode\\C_code\\grid_c.cgns",CG_MODE_READ,&index_file)) cg_error_exit();
